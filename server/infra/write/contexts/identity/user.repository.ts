...
import type { UserRoleRow, UserRow, UserWrite } from "@index/infra/write/contexts/identity/shema";
...
export class UserRepository extends AbstractRepository<User, UserWrite> implements IUserRepository {
    ...
    async getByName(name: string) {
        const [row] = await this.tx.query<UserWrite>
